...
export class UsersFormComponent implements OnInit {
    ...
    this.route.params.subscribe((params) => {
      if (params.id) {
        ...
        this.usersService.getUser(params.id).subscribe((user) => {
          ...
          this.userForm.passwordConfirm.setValidators([]);
          this.userForm.passwordConfirm.updateValueAndValidity();
        });
      }
    });
  }
  ...
  onSubmit() {
    ...
    if (this.editMode) {
      ...
      user.passwordConfirm = this.userForm.passwordConfirm.value;
